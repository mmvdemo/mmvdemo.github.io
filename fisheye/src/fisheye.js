...
const fisheyeScale = 5;
const linechartsTextureScale = 2;
const maxScale = 1.5;
const chartRatio=0.8;
const nodeRadius =0.2;
const focalWidth = 3, focalHeight = 3;
const distortWidth=31,distortHeight=31;
const distortWidth_pix=distortWidth*stepWidth_pix,distortHeight_pix=distortHeight*stepHeight_pix;
...
const linechartsSprite = new PIXI.Sprite();
